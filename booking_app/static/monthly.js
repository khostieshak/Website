				...
				$.get(''+options.xmlUrl+'', function(d){
					$(d).find('event').each(function(){
						...
						if (!fullendDate && startMonth == setMonth && startYear == setYear) {
							if (eventId==-1){ // If it a free spoot M-sektionen mod
									$('#'+uniqueId+' *[data-number="'+i+'"] .monthly-indicator-wrap').append('<div class="monthly-event-indicator" data-eventid="'+ eventId +'" style="background:'+eventColor+'" title="'+eventTitle+'" data-start="'+fullstartDate +' '+ startTime+ '" data-end="'+fullendDate+' '+ endTime+ '" data-toggle="modal" data-target="#BookingModal">'+eventTitle+'</div>');
								}else {
